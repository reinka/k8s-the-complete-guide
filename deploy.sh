...
kubectl set image deployments/client-deployment client=apoehlmann/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=apoehlmann/multi-worker:$SHA
